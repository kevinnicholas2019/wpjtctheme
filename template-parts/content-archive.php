    ...
    <div class="post mb-5">
        <div class="media d-md-flex d-sm-block">
            ...
            <div class="media-body">
                ...
                <div class="meta mb-1"><span class="date"><?= the_date() ?></span><span class="ms-2 me-2">|</span><i class="fas fa-comment me-1"></i> <span class="comment"><a href="#"><?= get_comments_number_text() ?></a></span></div>
